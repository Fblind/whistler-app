  ...
  return (
    <div className="mt-6 w-full px-4">
      ...
      <div className="flex flex-row justify-between items-center">
        ...
        <a className="text-indigo-600 text-sm cursor-pointer" onClick={resetKnowledges}>View all</a>
      </div>
      <TopicCarousel topics={topics} onTopicClick={handleTopicClick}></TopicCarousel>
      <div className="flex flex-row justify-between items-center">
...
function TopicCarousel ({ topics, onTopicClick }) {
  ...
  const TopicTag = (topic) => {
    ...
    return (
      <div key={topic} className="shadow-lg rounded-lg mr-2 inline-block cursor-pointer" onClick={() => onTopicClick(topic)}>
